...
class ServerCallback {
    /*
    // association with DB_ung class
    public $;
    // association with CreateUser class
    public $;
    // association with PBUY class
    public $;
    // association with SBUY class
    public $;
    */
    public function setSubscribeManagerInscription() {
        return;
    }
