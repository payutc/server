...
class Cas {
    public static function authenticate($ticket, $service) {
        ...
        if (isset($parsed->array['cas:serviceResponse']['cas:authenticationSuccess']['cas:user'])) return $parsed->array['cas:serviceResponse']['cas:authenticationSuccess']['cas:user'];
