 ...
 */
class TjObjPoiJopTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'payutc_server.map.TjObjPoiJopTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('TjObjPoiJop');
        $this->setClassname('TjObjPoiJop');
