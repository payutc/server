 ...
 */
class TRechargeRecTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'payutc_server.map.TRechargeRecTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('TRechargeRec');
        $this->setClassname('TRechargeRec');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('TRechargeTypeRty', 'TRechargeTypeRty', RelationMap::MANY_TO_ONE, array('rty_id' => 'rty_id', ), null, 'CASCADE');
        $this->addRelation('TsUserUsrRelatedByUsrIdBuyer', 'TsUserUsr', RelationMap::MANY_TO_ONE, array('usr_id_buyer' => 'usr_id', ), null, 'CASCADE');
        $this->addRelation('TsUserUsrRelatedByUsrIdOperator', 'TsUserUsr', RelationMap::MANY_TO_ONE, array('usr_id_operator' => 'usr_id', ), null, 'CASCADE');
    } // buildRelations()

} // TRechargeRecTableMap
