 ...
 */
class TsCallbackCalTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'payutc_server.map.TsCallbackCalTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('TsCallbackCal');
        $this->setClassname('TsCallbackCal');
