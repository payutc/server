 ...
 */
class TsImageImgTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'payutc_server.map.TsImageImgTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('TsImageImg');
        $this->setClassname('TsImageImg');
    ...
    {
        $this->addRelation('TObjectObj', 'TObjectObj', RelationMap::ONE_TO_MANY, array('img_id' => 'img_id', ), null, null, 'TObjectObjs');
        $this->addRelation('TsUserUsr', 'TsUserUsr', RelationMap::ONE_TO_MANY, array('img_id' => 'img_id', ), null, 'CASCADE', 'TsUserUsrs');
    } // buildRelations()
