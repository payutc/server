 ...
 */
abstract class BaseTPlagePla extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TPlagePlaPeer';
     ...
     * @return TPlagePla The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->pla_id !== $v) {
            $this->pla_id = $v;
            $this->modifiedColumns[] = TPlagePlaPeer::PLA_ID;
        }
    ...
    public function setFunId($v)
    {
        ...
        if ($this->fun_id !== $v) {
            $this->fun_id = $v;
            $this->modifiedColumns[] = TPlagePlaPeer::FUN_ID;
        }
    ...
    public function setPoiId($v)
    {
        ...
        if ($this->poi_id !== $v) {
            $this->poi_id = $v;
            $this->modifiedColumns[] = TPlagePlaPeer::POI_ID;
        }
    ...
    public function setStart($v)
    {
        ...
        if ($this->pla_start !== $v) {
            $this->pla_start = $v;
            $this->modifiedColumns[] = TPlagePlaPeer::PLA_START;
        }
    ...
    public function setEnd($v)
    {
        ...
        if ($this->pla_end !== $v) {
            $this->pla_end = $v;
            $this->modifiedColumns[] = TPlagePlaPeer::PLA_END;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->pla_name !== $v) {
            $this->pla_name = $v;
            $this->modifiedColumns[] = TPlagePlaPeer::PLA_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = TPlagePlaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TPlagePla object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TPlagePlaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TPlagePlaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TPlagePlaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TPlagePlaPeer::PLA_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PLA_ID`';
        }
        if ($this->isColumnModified(TPlagePlaPeer::FUN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`FUN_ID`';
        }
        if ($this->isColumnModified(TPlagePlaPeer::POI_ID)) {
            $modifiedColumns[':p' . $index++]  = '`POI_ID`';
        }
        if ($this->isColumnModified(TPlagePlaPeer::PLA_START)) {
            $modifiedColumns[':p' . $index++]  = '`PLA_START`';
        }
        if ($this->isColumnModified(TPlagePlaPeer::PLA_END)) {
            $modifiedColumns[':p' . $index++]  = '`PLA_END`';
        }
        if ($this->isColumnModified(TPlagePlaPeer::PLA_NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TPlagePlaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TPlagePlaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TPlagePla'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TPlagePla'][$this->getPrimaryKey()] = true;
        $keys = TPlagePlaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TPlagePlaPeer::PLA_ID)) $criteria->add(TPlagePlaPeer::PLA_ID, $this->pla_id);
        if ($this->isColumnModified(TPlagePlaPeer::FUN_ID)) $criteria->add(TPlagePlaPeer::FUN_ID, $this->fun_id);
        if ($this->isColumnModified(TPlagePlaPeer::POI_ID)) $criteria->add(TPlagePlaPeer::POI_ID, $this->poi_id);
        if ($this->isColumnModified(TPlagePlaPeer::PLA_START)) $criteria->add(TPlagePlaPeer::PLA_START, $this->pla_start);
        if ($this->isColumnModified(TPlagePlaPeer::PLA_END)) $criteria->add(TPlagePlaPeer::PLA_END, $this->pla_end);
        if ($this->isColumnModified(TPlagePlaPeer::PLA_NAME)) $criteria->add(TPlagePlaPeer::PLA_NAME, $this->pla_name);
    ...
    {
        $criteria = new Criteria(TPlagePlaPeer::DATABASE_NAME);
        $criteria->add(TPlagePlaPeer::PLA_ID, $this->pla_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of TPlagePla (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TPlagePla Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TPlagePlaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TPlagePlaPeer();
        }
    ...
    public function getTPointPoi(PropelPDO $con = null)
    {
        if ($this->aTPointPoi === null && ($this->poi_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTPointPoi->addTPlagePlas($this);
             */
        }
    ...
    public function getTFundationFun(PropelPDO $con = null)
    {
        if ($this->aTFundationFun === null && ($this->fun_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTFundationFun->addTPlagePlas($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(TPlagePlaPeer::DEFAULT_STRING_FORMAT);
    }
