 ...
 */
abstract class BaseTSherlocksShe extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TSherlocksShePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TSherlocksShePeer
     */
     ...
     * @return TSherlocksShe The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->she_id !== $v) {
            $this->she_id = $v;
            $this->modifiedColumns[] = TSherlocksShePeer::SHE_ID;
        }
    ...
    public function setUsrId($v)
    {
        ...
        if ($this->usr_id !== $v) {
            $this->usr_id = $v;
            $this->modifiedColumns[] = TSherlocksShePeer::USR_ID;
        }
    ...
    public function setStep($v)
    {
        ...
        if ($this->she_step !== $v) {
            $this->she_step = $v;
            $this->modifiedColumns[] = TSherlocksShePeer::SHE_STEP;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->she_amount !== $v) {
            $this->she_amount = $v;
            $this->modifiedColumns[] = TSherlocksShePeer::SHE_AMOUNT;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->she_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TSherlocksShePeer::SHE_DATE;
            }
    ...
    public function setParentId($v)
    {
        ...
        if ($this->she_parent_id !== $v) {
            ...
            $this->modifiedColumns[] = TSherlocksShePeer::SHE_PARENT_ID;
        }
    ...
    public function setState($v)
    {
        ...
        if ($this->she_state !== $v) {
            $this->she_state = $v;
            $this->modifiedColumns[] = TSherlocksShePeer::SHE_STATE;
        }
    ...
    public function setTrace($v)
    {
        ...
        if ($this->she_trace !== $v) {
            $this->she_trace = $v;
            $this->modifiedColumns[] = TSherlocksShePeer::SHE_TRACE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 8; // 8 = TSherlocksShePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TSherlocksShe object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TSherlocksShePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TSherlocksSheQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TSherlocksShePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TSherlocksShePeer::SHE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`SHE_ID`';
        }
        if ($this->isColumnModified(TSherlocksShePeer::USR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USR_ID`';
        }
        if ($this->isColumnModified(TSherlocksShePeer::SHE_STEP)) {
            $modifiedColumns[':p' . $index++]  = '`SHE_STEP`';
        }
        if ($this->isColumnModified(TSherlocksShePeer::SHE_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = '`SHE_AMOUNT`';
        }
        if ($this->isColumnModified(TSherlocksShePeer::SHE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`SHE_DATE`';
        }
        if ($this->isColumnModified(TSherlocksShePeer::SHE_PARENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`SHE_PARENT_ID`';
        }
        if ($this->isColumnModified(TSherlocksShePeer::SHE_STATE)) {
            $modifiedColumns[':p' . $index++]  = '`SHE_STATE`';
        }
        if ($this->isColumnModified(TSherlocksShePeer::SHE_TRACE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TSherlocksShePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TSherlocksShePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TSherlocksShe'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TSherlocksShe'][$this->getPrimaryKey()] = true;
        $keys = TSherlocksShePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TSherlocksShePeer::SHE_ID)) $criteria->add(TSherlocksShePeer::SHE_ID, $this->she_id);
        if ($this->isColumnModified(TSherlocksShePeer::USR_ID)) $criteria->add(TSherlocksShePeer::USR_ID, $this->usr_id);
        if ($this->isColumnModified(TSherlocksShePeer::SHE_STEP)) $criteria->add(TSherlocksShePeer::SHE_STEP, $this->she_step);
        if ($this->isColumnModified(TSherlocksShePeer::SHE_AMOUNT)) $criteria->add(TSherlocksShePeer::SHE_AMOUNT, $this->she_amount);
        if ($this->isColumnModified(TSherlocksShePeer::SHE_DATE)) $criteria->add(TSherlocksShePeer::SHE_DATE, $this->she_date);
        if ($this->isColumnModified(TSherlocksShePeer::SHE_PARENT_ID)) $criteria->add(TSherlocksShePeer::SHE_PARENT_ID, $this->she_parent_id);
        if ($this->isColumnModified(TSherlocksShePeer::SHE_STATE)) $criteria->add(TSherlocksShePeer::SHE_STATE, $this->she_state);
        if ($this->isColumnModified(TSherlocksShePeer::SHE_TRACE)) $criteria->add(TSherlocksShePeer::SHE_TRACE, $this->she_trace);
    ...
    {
        $criteria = new Criteria(TSherlocksShePeer::DATABASE_NAME);
        $criteria->add(TSherlocksShePeer::SHE_ID, $this->she_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of TSherlocksShe (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TSherlocksShe Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TSherlocksShePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TSherlocksShePeer();
        }
    ...
    public function getTsUserUsr(PropelPDO $con = null)
    {
        if ($this->aTsUserUsr === null && ($this->usr_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTsUserUsr->addTSherlocksShes($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(TSherlocksShePeer::DEFAULT_STRING_FORMAT);
    }
