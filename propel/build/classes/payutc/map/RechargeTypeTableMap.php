 ...
 */
class RechargeTypeTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'payutc.map.RechargeTypeTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('RechargeType');
        $this->setClassname('Payutc\\RechargeType');
    ...
    {
        $this->addRelation('Recharge', 'Payutc\\Recharge', RelationMap::ONE_TO_MANY, array('rty_id' => 'rty_id', ), null, 'CASCADE', 'Recharges');
    } // buildRelations()

} // RechargeTypeTableMap
