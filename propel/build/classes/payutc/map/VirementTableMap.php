 ...
 */
class VirementTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'payutc.map.VirementTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('Virement');
        $this->setClassname('Payutc\\Virement');
    ...
    {
        $this->addRelation('UserRelatedByUsrIdTo', 'Payutc\\User', RelationMap::MANY_TO_ONE, array('usr_id_to' => 'usr_id', ), null, 'CASCADE');
        $this->addRelation('UserRelatedByUsrIdFrom', 'Payutc\\User', RelationMap::MANY_TO_ONE, array('usr_id_from' => 'usr_id', ), null, 'CASCADE');
    } // buildRelations()
