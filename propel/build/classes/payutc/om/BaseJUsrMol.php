 ...
 */
abstract class BaseJUsrMol extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Payutc\\JUsrMolPeer';
     ...
     * @return JUsrMol The current object (for fluent API support)
     */
    public function setUsrId($v)
    {
        ...
        if ($this->usr_id !== $v) {
            $this->usr_id = $v;
            $this->modifiedColumns[] = JUsrMolPeer::USR_ID;
        }
    ...
    public function setMolId($v)
    {
        ...
        if ($this->mol_id !== $v) {
            $this->mol_id = $v;
            $this->modifiedColumns[] = JUsrMolPeer::MOL_ID;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->jum_data !== $v) {
            $this->jum_data = $v;
            $this->modifiedColumns[] = JUsrMolPeer::JUM_DATA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = JUsrMolPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JUsrMol object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JUsrMolPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JUsrMolQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JUsrMolPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JUsrMolPeer::USR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USR_ID`';
        }
        if ($this->isColumnModified(JUsrMolPeer::MOL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`MOL_ID`';
        }
        if ($this->isColumnModified(JUsrMolPeer::JUM_DATA)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JUsrMolPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JUsrMolPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JUsrMol'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JUsrMol'][serialize($this->getPrimaryKey())] = true;
        $keys = JUsrMolPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JUsrMolPeer::USR_ID)) $criteria->add(JUsrMolPeer::USR_ID, $this->usr_id);
        if ($this->isColumnModified(JUsrMolPeer::MOL_ID)) $criteria->add(JUsrMolPeer::MOL_ID, $this->mol_id);
        if ($this->isColumnModified(JUsrMolPeer::JUM_DATA)) $criteria->add(JUsrMolPeer::JUM_DATA, $this->jum_data);
    ...
    {
        $criteria = new Criteria(JUsrMolPeer::DATABASE_NAME);
        $criteria->add(JUsrMolPeer::USR_ID, $this->usr_id);
        $criteria->add(JUsrMolPeer::MOL_ID, $this->mol_id);
        $criteria->add(JUsrMolPeer::JUM_DATA, $this->jum_data);
     ...
     * objects.
     *
     * @param object $copyObj An object of JUsrMol (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JUsrMol Clone of current object.
     * @throws PropelException
     */
    ...
    public function getMeanOfLogin(PropelPDO $con = null)
    {
        if ($this->aMeanOfLogin === null && ($this->mol_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMeanOfLogin->addJUsrMols($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(JUsrMolPeer::DEFAULT_STRING_FORMAT);
    }
