 ...
 */
abstract class BasePrice extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Payutc\\PricePeer';
    ...
    /**
     * Initializes internal state of BasePrice object.
     * @see        applyDefaults()
     */
     ...
     * @return Price The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->pri_id !== $v) {
            $this->pri_id = $v;
            $this->modifiedColumns[] = PricePeer::PRI_ID;
        }
    ...
    public function setObjId($v)
    {
        ...
        if ($this->obj_id !== $v) {
            $this->obj_id = $v;
            $this->modifiedColumns[] = PricePeer::OBJ_ID;
        }
    ...
    public function setGrpId($v)
    {
        ...
        if ($this->grp_id !== $v) {
            $this->grp_id = $v;
            $this->modifiedColumns[] = PricePeer::GRP_ID;
        }
    ...
    public function setPerId($v)
    {
        ...
        if ($this->per_id !== $v) {
            $this->per_id = $v;
            $this->modifiedColumns[] = PricePeer::PER_ID;
        }
    ...
    public function setCredit($v)
    {
        ...
        if ($this->pri_credit !== $v) {
            $this->pri_credit = $v;
            $this->modifiedColumns[] = PricePeer::PRI_CREDIT;
        }
    ...
    public function setRemoved($v)
    {
        ...
        if ($this->pri_removed !== $v) {
            $this->pri_removed = $v;
            $this->modifiedColumns[] = PricePeer::PRI_REMOVED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = PricePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Price object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aGroup !== null && $this->grp_id !== $this->aGroup->getId()) {
            $this->aGroup = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PricePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PricePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PricePeer::PRI_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PRI_ID`';
        }
        if ($this->isColumnModified(PricePeer::OBJ_ID)) {
            $modifiedColumns[':p' . $index++]  = '`OBJ_ID`';
        }
        if ($this->isColumnModified(PricePeer::GRP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`GRP_ID`';
        }
        if ($this->isColumnModified(PricePeer::PER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PER_ID`';
        }
        if ($this->isColumnModified(PricePeer::PRI_CREDIT)) {
            $modifiedColumns[':p' . $index++]  = '`PRI_CREDIT`';
        }
        if ($this->isColumnModified(PricePeer::PRI_REMOVED)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PricePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PricePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Price'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Price'][$this->getPrimaryKey()] = true;
        $keys = PricePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PricePeer::PRI_ID)) $criteria->add(PricePeer::PRI_ID, $this->pri_id);
        if ($this->isColumnModified(PricePeer::OBJ_ID)) $criteria->add(PricePeer::OBJ_ID, $this->obj_id);
        if ($this->isColumnModified(PricePeer::GRP_ID)) $criteria->add(PricePeer::GRP_ID, $this->grp_id);
        if ($this->isColumnModified(PricePeer::PER_ID)) $criteria->add(PricePeer::PER_ID, $this->per_id);
        if ($this->isColumnModified(PricePeer::PRI_CREDIT)) $criteria->add(PricePeer::PRI_CREDIT, $this->pri_credit);
        if ($this->isColumnModified(PricePeer::PRI_REMOVED)) $criteria->add(PricePeer::PRI_REMOVED, $this->pri_removed);
    ...
    {
        $criteria = new Criteria(PricePeer::DATABASE_NAME);
        $criteria->add(PricePeer::PRI_ID, $this->pri_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Price (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Price Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aGroup === null && ($this->grp_id !== null)) {
            $this->aGroup = GroupQuery::create()->findPk($this->grp_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGroup->addPrices($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PricePeer::DEFAULT_STRING_FORMAT);
    }
