...
abstract class BaseSalePeer
{
    ...
    /**
     * An identiy map to hold any loaded instances of Sale objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (SalePeer::SAL_ID, SalePeer::SAL_NAME, SalePeer::PER_ID, SalePeer::OBJ_ID, SalePeer::SAL_REMOVED, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (SalePeer::SAL_ID => 0, SalePeer::SAL_NAME => 1, SalePeer::PER_ID => 2, SalePeer::OBJ_ID => 3, SalePeer::SAL_REMOVED => 4, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SalePeer::SAL_ID);
            $criteria->addSelectColumn(SalePeer::SAL_NAME);
            $criteria->addSelectColumn(SalePeer::PER_ID);
            $criteria->addSelectColumn(SalePeer::OBJ_ID);
            $criteria->addSelectColumn(SalePeer::SAL_REMOVED);
        } else {
    ...
    public static function doCountJoinItem(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SalePeer::OBJ_ID, ItemPeer::OBJ_ID, $join_behavior);
    ...
    public static function doCountJoinPeriod(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SalePeer::PER_ID, PeriodPeer::PER_ID, $join_behavior);
    ...
    /**
     * Selects a collection of Sale objects pre-filled with their Item objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinItem(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Sale) to $obj2 (Item)
                $obj2->addSale($obj1);
    ...
    /**
     * Selects a collection of Sale objects pre-filled with their Period objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Sale objects.
    ...
    public static function doSelectJoinPeriod(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Sale) to $obj2 (Period)
                $obj2->addSale($obj1);
    ...
    /**
     * Selects a collection of Sale objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PeriodPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + PeriodPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Sale) to the collection in $obj2 (Item)
                $obj2->addSale($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Sale) to the collection in $obj3 (Period)
                $obj3->addSale($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Sale objects pre-filled with all related objects except Item.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptItem(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = SalePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Sale) to the collection in $obj2 (Period)
                $obj2->addSale($obj1);
    ...
    /**
     * Selects a collection of Sale objects pre-filled with all related objects except Period.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(SalePeer::SAL_ID) && $criteria->keyContainsValue(SalePeer::SAL_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(SalePeer::SAL_ID);
            $value = $criteria->remove(SalePeer::SAL_ID);
            if ($value) {
                $selectCriteria->add(SalePeer::SAL_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(SalePeer::SAL_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(SalePeer::DATABASE_NAME);
        $criteria->add(SalePeer::SAL_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(SalePeer::DATABASE_NAME);
            $criteria->add(SalePeer::SAL_ID, $pks, Criteria::IN);
