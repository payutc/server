...
abstract class BaseRightPeer
{
     ...
     * e.g. RightPeer::$fieldNames[RightPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (RightPeer::RIG_ID, RightPeer::RIG_NAME, RightPeer::RIG_DESCRIPTION, RightPeer::RIG_ADMIN, RightPeer::RIG_REMOVED, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. RightPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (RightPeer::RIG_ID => 0, RightPeer::RIG_NAME => 1, RightPeer::RIG_DESCRIPTION => 2, RightPeer::RIG_ADMIN => 3, RightPeer::RIG_REMOVED => 4, ),
    ...
    {
        $toNames = RightPeer::getFieldNames($toType);
        $key = isset(RightPeer::$fieldKeys[$fromType][$name]) ? RightPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(RightPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, RightPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return RightPeer::$fieldNames[$type];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(RightPeer::RIG_ID);
            $criteria->addSelectColumn(RightPeer::RIG_NAME);
            $criteria->addSelectColumn(RightPeer::RIG_DESCRIPTION);
            $criteria->addSelectColumn(RightPeer::RIG_ADMIN);
            $criteria->addSelectColumn(RightPeer::RIG_REMOVED);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(RightPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(RightPeer::DATABASE_NAME);
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(RightPeer::$instances[$key])) {
                return RightPeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(RightPeer::DATABASE_NAME)->getTable(RightPeer::TABLE_NAME);
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(RightPeer::RIG_ID) && $criteria->keyContainsValue(RightPeer::RIG_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(RightPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(RightPeer::RIG_ID);
            $value = $criteria->remove(RightPeer::RIG_ID);
            if ($value) {
                $selectCriteria->add(RightPeer::RIG_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(RightPeer::RIG_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(RightPeer::DATABASE_NAME);
        $criteria->add(RightPeer::RIG_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(RightPeer::DATABASE_NAME);
            $criteria->add(RightPeer::RIG_ID, $pks, Criteria::IN);
