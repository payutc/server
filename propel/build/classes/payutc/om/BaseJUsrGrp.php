 ...
 */
abstract class BaseJUsrGrp extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Payutc\\JUsrGrpPeer';
    ...
    /**
     * Initializes internal state of BaseJUsrGrp object.
     * @see        applyDefaults()
     */
     ...
     * @return JUsrGrp The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->jug_id !== $v) {
            $this->jug_id = $v;
            $this->modifiedColumns[] = JUsrGrpPeer::JUG_ID;
        }
    ...
    public function setUsrId($v)
    {
        ...
        if ($this->usr_id !== $v) {
            $this->usr_id = $v;
            $this->modifiedColumns[] = JUsrGrpPeer::USR_ID;
        }
    ...
    public function setGrpId($v)
    {
        ...
        if ($this->grp_id !== $v) {
            $this->grp_id = $v;
            $this->modifiedColumns[] = JUsrGrpPeer::GRP_ID;
        }
    ...
    public function setPerId($v)
    {
        ...
        if ($this->per_id !== $v) {
            $this->per_id = $v;
            $this->modifiedColumns[] = JUsrGrpPeer::PER_ID;
        }
    ...
    public function setRemoved($v)
    {
        ...
        if ($this->jug_removed !== $v) {
            $this->jug_removed = $v;
            $this->modifiedColumns[] = JUsrGrpPeer::JUG_REMOVED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = JUsrGrpPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JUsrGrp object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JUsrGrpPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JUsrGrpQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JUsrGrpPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JUsrGrpPeer::JUG_ID)) {
            $modifiedColumns[':p' . $index++]  = '`JUG_ID`';
        }
        if ($this->isColumnModified(JUsrGrpPeer::USR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USR_ID`';
        }
        if ($this->isColumnModified(JUsrGrpPeer::GRP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`GRP_ID`';
        }
        if ($this->isColumnModified(JUsrGrpPeer::PER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PER_ID`';
        }
        if ($this->isColumnModified(JUsrGrpPeer::JUG_REMOVED)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JUsrGrpPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JUsrGrpPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JUsrGrp'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JUsrGrp'][serialize($this->getPrimaryKey())] = true;
        $keys = JUsrGrpPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JUsrGrpPeer::JUG_ID)) $criteria->add(JUsrGrpPeer::JUG_ID, $this->jug_id);
        if ($this->isColumnModified(JUsrGrpPeer::USR_ID)) $criteria->add(JUsrGrpPeer::USR_ID, $this->usr_id);
        if ($this->isColumnModified(JUsrGrpPeer::GRP_ID)) $criteria->add(JUsrGrpPeer::GRP_ID, $this->grp_id);
        if ($this->isColumnModified(JUsrGrpPeer::PER_ID)) $criteria->add(JUsrGrpPeer::PER_ID, $this->per_id);
        if ($this->isColumnModified(JUsrGrpPeer::JUG_REMOVED)) $criteria->add(JUsrGrpPeer::JUG_REMOVED, $this->jug_removed);
    ...
    {
        $criteria = new Criteria(JUsrGrpPeer::DATABASE_NAME);
        $criteria->add(JUsrGrpPeer::USR_ID, $this->usr_id);
        $criteria->add(JUsrGrpPeer::GRP_ID, $this->grp_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getUsrId()) && (null === $this->getGrpId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JUsrGrp (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JUsrGrp Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(JUsrGrpPeer::DEFAULT_STRING_FORMAT);
    }
