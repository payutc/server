...
abstract class BaseLog extends BaseObject implements Persistent
{
    ...
    public function setDate($v)
    {
        ...
        if ($this->log_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LogPeer::LOG_DATE;
            }
    ...
    public function setGravity($v)
    {
        ...
        if ($this->log_gravity !== $v) {
            $this->log_gravity = $v;
            $this->modifiedColumns[] = LogPeer::LOG_GRAVITY;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->log_message !== $v) {
            $this->log_message = $v;
            $this->modifiedColumns[] = LogPeer::LOG_MESSAGE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = LogPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = LogPeer::LOG_ID;
        if (null !== $this->log_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . LogPeer::LOG_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(LogPeer::LOG_ID)) {
            $modifiedColumns[':p' . $index++]  = '`LOG_ID`';
        }
        if ($this->isColumnModified(LogPeer::LOG_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`LOG_DATE`';
        }
        if ($this->isColumnModified(LogPeer::LOG_GRAVITY)) {
            $modifiedColumns[':p' . $index++]  = '`LOG_GRAVITY`';
        }
        if ($this->isColumnModified(LogPeer::LOG_MESSAGE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LogPeer::LOG_DATE)) $criteria->add(LogPeer::LOG_DATE, $this->log_date);
        if ($this->isColumnModified(LogPeer::LOG_GRAVITY)) $criteria->add(LogPeer::LOG_GRAVITY, $this->log_gravity);
        if ($this->isColumnModified(LogPeer::LOG_MESSAGE)) $criteria->add(LogPeer::LOG_MESSAGE, $this->log_message);
