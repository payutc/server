...
abstract class BasePointPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PointPeer::POI_ID, PointPeer::POI_NAME, PointPeer::POI_REMOVED, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PointPeer::POI_ID => 0, PointPeer::POI_NAME => 1, PointPeer::POI_REMOVED => 2, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PointPeer::POI_ID);
            $criteria->addSelectColumn(PointPeer::POI_NAME);
            $criteria->addSelectColumn(PointPeer::POI_REMOVED);
        } else {
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(PointPeer::POI_ID) && $criteria->keyContainsValue(PointPeer::POI_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(PointPeer::POI_ID);
            $value = $criteria->remove(PointPeer::POI_ID);
            if ($value) {
                $selectCriteria->add(PointPeer::POI_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(PointPeer::POI_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(PointPeer::DATABASE_NAME);
        $criteria->add(PointPeer::POI_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PointPeer::DATABASE_NAME);
            $criteria->add(PointPeer::POI_ID, $pks, Criteria::IN);
