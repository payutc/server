...
abstract class BaseLogPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (LogPeer::LOG_ID, LogPeer::LOG_DATE, LogPeer::LOG_GRAVITY, LogPeer::LOG_MESSAGE, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (LogPeer::LOG_ID => 0, LogPeer::LOG_DATE => 1, LogPeer::LOG_GRAVITY => 2, LogPeer::LOG_MESSAGE => 3, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LogPeer::LOG_DATE);
            $criteria->addSelectColumn(LogPeer::LOG_GRAVITY);
            $criteria->addSelectColumn(LogPeer::LOG_MESSAGE);
        } else {
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(LogPeer::LOG_ID) && $criteria->keyContainsValue(LogPeer::LOG_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(LogPeer::LOG_ID);
            if ($value) {
                $selectCriteria->add(LogPeer::LOG_ID, $value, $comparison);
            } else {
