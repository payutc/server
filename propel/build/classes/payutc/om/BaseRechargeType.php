 ...
 */
abstract class BaseRechargeType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Payutc\\RechargeTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RechargeTypePeer
     */
    ...
    /**
     * Initializes internal state of BaseRechargeType object.
     * @see        applyDefaults()
     */
     ...
     * @return RechargeType The current object (for fluent API support)
     */
    public function setRtyId($v)
    {
        ...
        if ($this->rty_id !== $v) {
            $this->rty_id = $v;
            $this->modifiedColumns[] = RechargeTypePeer::RTY_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->rty_name !== $v) {
            $this->rty_name = $v;
            $this->modifiedColumns[] = RechargeTypePeer::RTY_NAME;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->rty_type !== $v) {
            $this->rty_type = $v;
            $this->modifiedColumns[] = RechargeTypePeer::RTY_TYPE;
        }
    ...
    public function setRemoved($v)
    {
        ...
        if ($this->rty_removed !== $v) {
            $this->rty_removed = $v;
            $this->modifiedColumns[] = RechargeTypePeer::RTY_REMOVED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = RechargeTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RechargeType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RechargeTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RechargeTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RechargeTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RechargeTypePeer::RTY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`RTY_ID`';
        }
        if ($this->isColumnModified(RechargeTypePeer::RTY_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`RTY_NAME`';
        }
        if ($this->isColumnModified(RechargeTypePeer::RTY_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`RTY_TYPE`';
        }
        if ($this->isColumnModified(RechargeTypePeer::RTY_REMOVED)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RechargeTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RechargeTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['RechargeType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RechargeType'][$this->getPrimaryKey()] = true;
        $keys = RechargeTypePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RechargeTypePeer::RTY_ID)) $criteria->add(RechargeTypePeer::RTY_ID, $this->rty_id);
        if ($this->isColumnModified(RechargeTypePeer::RTY_NAME)) $criteria->add(RechargeTypePeer::RTY_NAME, $this->rty_name);
        if ($this->isColumnModified(RechargeTypePeer::RTY_TYPE)) $criteria->add(RechargeTypePeer::RTY_TYPE, $this->rty_type);
        if ($this->isColumnModified(RechargeTypePeer::RTY_REMOVED)) $criteria->add(RechargeTypePeer::RTY_REMOVED, $this->rty_removed);
    ...
    {
        $criteria = new Criteria(RechargeTypePeer::DATABASE_NAME);
        $criteria->add(RechargeTypePeer::RTY_ID, $this->rty_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of RechargeType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RechargeType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RechargeTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RechargeTypePeer();
        }
     ...
     * If this RechargeType is new, it will return
    ...
    public function setRecharges(PropelCollection $recharges, PropelPDO $con = null)
    {
        ...
        foreach ($this->rechargesScheduledForDeletion as $rechargeRemoved) {
            $rechargeRemoved->setRechargeType(null);
        }
     ...
     * Otherwise if this RechargeType is new, it will return
     * an empty collection; or if this RechargeType has previously
     * been saved, it will retrieve related Recharges from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RechargeType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Recharge[] List of Recharge objects
     */
    public function getRechargesJoinPoint($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RechargeQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(RechargeTypePeer::DEFAULT_STRING_FORMAT);
    }
